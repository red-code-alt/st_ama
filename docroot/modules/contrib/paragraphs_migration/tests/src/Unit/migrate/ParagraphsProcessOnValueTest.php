...
use Drupal\paragraphs_migration\Plugin\migrate\process\ParagraphsProcessOnValue;
use Symfony\Component\EventDispatcher\EventDispatcherInterface;

/**
 * Test class for the pm_paragraphs_process_on_value process plugin.
 *
...
class ParagraphsProcessOnValueTest extends ProcessTestCase {
  ...
  public function setup() {
    ...
    $this->plugin = new ParagraphsProcessOnValue($configuration, 'pm_paragraphs_process_on_value', [], $this->entityTypeBundleInfo);
    $this->row
      ->expects($this->any())
      ->method('getSource')
      ->willReturn([
